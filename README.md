...
| `didInternalQueueOverflow()`                       | **bool**          | Returns whether the internal queue lost messages at some point due to being full. This can happen if you send too much data with slow `interval` configuration. The flag is cleared on each call.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `didExternalQueueOverflow()`                       | **bool**          | Returns whether the external queue lost messages at some point due to being full. This can happen if you receive too much data without calling `receive(...)` enough times. The flag is cleared on each call.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
