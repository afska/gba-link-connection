...
typedef enum {
  ...
  C_LINK_CABLE_MULTIBOOT_ASYNC_RESULT_INVALID_SIZE = 1,
  C_LINK_CABLE_MULTIBOOT_ASYNC_RESULT_SEND_FAILURE = 2,
  C_LINK_CABLE_MULTIBOOT_ASYNC_RESULT_FINAL_HANDSHAKE_FAILURE = 3,
  C_LINK_CABLE_MULTIBOOT_ASYNC_RESULT_CRC_FAILURE = 4,
} Result;
